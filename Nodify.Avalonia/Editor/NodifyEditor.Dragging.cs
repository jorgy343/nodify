...
public partial class NodifyEditor
{
    ...
    private static readonly DirectProperty<NodifyEditor, bool> IsDraggingPropertyKey =
    ...
    {
        get => GetValue(ItemsDragStartedCommandProperty);
    ...
    {
        get => GetValue(ItemsDragCompletedCommandProperty);
    ...
    {
        get => _isDragging;
        private set => SetAndRaise(IsDraggingPropertyKey, ref _isDragging, value);
    }
    ...
    public static readonly RoutedEvent<ItemsMovedEventArgs> ItemsMovedEvent =
        RoutedEvent.Register<NodifyEditor, ItemsMovedEventArgs>(
            nameof(ItemsMoved),
            RoutingStrategies.Bubble);

    /// <summary>
    /// Occurs when items are moved within the editor (see <see cref="BeginDragging()"/>, <see cref="BeginPushingItems(Point, Avalonia.Layout.Orientation)"/>).
    /// </summary>
